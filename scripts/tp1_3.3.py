...
def showGhostASSIN():
    print("\nEste produto com esse asin não existe:( \n")


def showWrongChoice():
    print("_____________________________________________________\n")
    print("Desculpe, mas essa escolha não esta disponível no sistema\nPor favor, digite as opções dentro do menu\n")
    print("_____________________________________________________\n")
...
def query6():
    print("\n\nPegue um cafezinho, essa consulta pode demorar um pouco! ;D\n")
